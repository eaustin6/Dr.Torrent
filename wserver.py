...
<head>
    ...
    <link rel="icon" href="https://github.com/TheCaduceus/Torrent-to-GoogleDrive/blob/main/Img/logo.jpg?raw=true" type="image/jpg">
    <script
...
<body>
  <!--© Designed and coded by Dr.Caduceus-->
    <header>
      <div class="brand">
        <img
          src="https://github.com/TheCaduceus/Torrent-to-GoogleDrive/blob/main/Img/logo.jpg?raw=true"
          alt="logo"
        />
        <a href="https://www.caduceus.ml/"> 
          <h2 class="name">Mirror Bot</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/TheCaduceus/DrTorrent"><i class="fab fa-github"></i></a>
        <a href="https://www.caduceus.ml/"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See Mirror Bot <a href='https://github.com/TheCaduceus/DrTorrent'>@GitHub</a> By <a href='https://github.com/TheCaduceus'></a></h1>", content_type="text/html")
    ...
    async def middleware_handler(request):
        ...
        try:
            ...
            if response.status == 404:
                return web.Response(text="<h1>404: Page not found</h2><br><h3>Mirror Bot</h3>", content_type="text/html")
            return response
